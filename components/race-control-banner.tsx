...
export function RaceControlBanner({
  ...
  return (
    ...
    >
      ...
      <div className="flex w-14 shrink-0 flex-col items-center justify-center gap-1.5 bg-banner py-3 pr-2 pl-4">
        <svg
          className="block"
          height="32"
      ...
      <div className="flex flex-col justify-center bg-banner py-3 pr-5 pl-3 text-banner-foreground">
        <p className="text-pretty font-bold text-base uppercase leading-tight tracking-wide">
          {heading}
        </p>
        <p className="mt-0.5 text-pretty font-medium text-banner-muted text-sm uppercase leading-tight tracking-wide">
          {detail}
        </p>
      </div>
    </div>
