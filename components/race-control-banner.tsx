...
export function RaceControlBanner({
  ...
  return (
    ...
    >
      {/* Icon badge (left navy block) */}
      <div className="flex shrink-0 flex-col items-center justify-center bg-[#0d2134] py-3 pr-2 pl-4">
        <svg
          className="size-8 scale-x-[-1] fill-current"
          version="1.0"
          viewBox="0 0 900 900"
