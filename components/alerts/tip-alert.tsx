...
export function TipAlert({ name, text }: AlertProps) {
...
TipAlert.getBotrixHtml =
  ...
  <div class="f1-alert-banner">
    ...
    <div class="f1-alert-body">
      <p class="f1-heading-text" id="alert-heading">RACE CONTROL: PIT STOP INCIDENT</p>
  ...
  <script>
    (function() {
      ...
      if (template) {
        ...
        if (headingEl) {
          headingEl.textContent = 'RACE CONTROL: ' + nameVal.toUpperCase() + ' PIT STOP INCIDENT';
        }
        if (detailEl) {
